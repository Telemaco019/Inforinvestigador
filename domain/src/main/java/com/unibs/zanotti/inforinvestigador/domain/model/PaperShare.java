...
public class PaperShare implements Parcelable {
    ...
    public PaperShare(String paperId,
                      String paperTitle,
    ...
    public static final Creator<PaperShare> CREATOR = new Creator<PaperShare>() {
        @Override
        public PaperShare createFromParcel(Parcel source) {
            return new PaperShare(source);
        }

        @Override
        public PaperShare[] newArray(int size) {
            return new PaperShare[0];
        }
    };
