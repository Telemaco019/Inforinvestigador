...
class HomeFragment : Fragment(), PaperSuggestionAdapter.OnPaperSuggestionListener {
    ...
    init {
        paperSuggestions = getPaperSuggestionDataset()
        researcherSuggestions = getResearcherSuggestionDataset()
    }
    ...
    private fun getPaperSuggestionDataset(): ArrayList<PaperSuggestion> {
        ...
        result.add(PaperSuggestion(paperId, title, authors, date, topics, comment, sharingUser, sharingProfilePicture))
