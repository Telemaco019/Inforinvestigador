    ...
    public Completable saveUser(User user) {
        return Completable.create(emitter -> {
            ...
            if (StringUtils.isBlank(user.getId())) {
                ...
                DocumentReference paperDocument = firebaseFirestore.collection(Collections.USERS).document();
                userEntity.setId(paperDocument.getId());
                user.setId(userEntity.getId());
            }

            firebaseFirestore.document(String.format("%s/%s", Collections.USERS, user.getId()))
                    .set(userEntity)
